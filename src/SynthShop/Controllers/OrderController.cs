...
public class OrderController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateOrder([FromBody] CreateOrderDTO createOrderDto)
    {
        ...
        var orderResult =
            await _orderService.CreateOrder(createOrderDto.BasketId, _userProvider.GetCurrentUserId()!.Value);
    ...
    public async Task<IActionResult> GetOrdersByCustomerId()
    {
        ...
        if (customerId == null) return Unauthorized("Customer ID not found.");
