...
public class BasketService : IBasketService
{
    ...
    public BasketService(IBasketRepository basketRepository, ILogger logger, IProductRepository productRepository,
        IBasketItemRepository basketItemRepository, IUnitOfWork unitOfWork)
    {
